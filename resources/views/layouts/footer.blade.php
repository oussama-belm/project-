...
<div class="container flex justify-center align-items-center py-20">
  <h1 class="text-black text-2xl font-serif font-bold my-auto">Footer 1</h1>
</div>
...
<!-- FOOTER 2 -->
<div class="container flex justify-center align-items-center py-20">
  <h1 class="text-black text-2xl font-serif font-bold my-auto">Footer 2</h1>
</div>
