...
<body>
    <div id="app">
            ...
            <header class="header_section">
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container align-items-center ">
                    ...
                    <div class="collapse navbar-collapse mt-2" id="navbarSupportedContent">
                        <ul class="navbar-nav  ">
                            ...
                            <li class="nav-item">
                            <a class="nav-link" href="/vendeur/create">Contact us</a>
                            </li>
                ...
                <a href="\panier\{{ Auth::user()->id }}">
                <div class="shoppingCart mt-3 ml-3">
                    <div class="shoppingIcon">
                        <img src="/images/svg/bxs-cart.svg" alt="">
                        <span class="itemNumber" style="display: flex;">{{ count(Auth::user()->panier->produits) }}</span>
                    </div>
                </div>
                </a>
                @endguest
    ...
    <!--
        ...
        <script>
                window.addEventListener("load", event => {
                    ...
                    const btnAdd = document.querySelector('.btnp.addtopanier'),
                ...
                let = priceFinal = document.querySelector('.priceFinal'),
                    nbrproduct  = document.querySelector('.nbrproduct');
                ...
                function addItem() {
                    ...
                    let cenas = parseInt(itemNumber.innerText)+parseInt(nbrproduct.value);
                    if (cenas  <= { $product ?? ''->quantite }) {
